...
open class RequestConfiguration {
  open static var `default` = RequestConfiguration()
  ...
  open var authenticationRealm: String = Bundle.main.infoDictionary?["AuthenticationRealm"] as? String ?? "Restricted"

  
  open var defaultProtectionSpace = URLProtectionSpace(host: baseURL,
                                                       port: 443,
